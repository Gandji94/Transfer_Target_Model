...
#----------------------------------------------------------------------------- setting up the paths for the file -----------------------------------------------------------------------------------------------
ROOT = Path(__file__).resolve().parent.parent

DATA_PROCESSED = ROOT / "DataSources" / "Processed"
DATA_LEAGUE_RAW = ROOT / "DataSources" / "Raw"
DATA_PLAYER_STATS = ROOT / "DataSources" / "Processed" / "Player_Stats_2017_2025.csv"
DATA_PLAYER_STATS_MEAN = ROOT / "DataSources" / "Processed" / "Player_Stats_Mean_2017_2025.csv"
DATA_FINAL_STATS = ROOT / "DataSources" / "Processed" / "Final_Stats_2000_2025.csv"
DATA_CLEANED_FINAL_STATS = ROOT / "DataSources" / "Processed" / "Cleaned_Final_Stats.csv"

#----------------------------------------------------------------------------- setting up the logging info -----------------------------------------------------------------------------------------------
def webscrapper_stats_gathering():
...
#----------------------------------------------------------------------------- running the webscrapper -----------------------------------------------------------------------------------------------
    ...
    try:
        ...
        all_trans_df.to_csv(DATA_PROCESSED / 'All_Trans_2000_2025.csv')
    ...
    try:
        ...
        df_pl.to_csv(DATA_LEAGUE_RAW / 'Premier_League_Stats_2017_2025.csv')
    ...
    try:
        ...
        df_esp.to_csv(DATA_LEAGUE_RAW / 'La_Liga_Stats_2017_2025.csv')
    ...
    try:
        ...
        df_seriea.to_csv(DATA_LEAGUE_RAW / 'Serie_A_Stats_2017_2025.csv')
    ...
    try:
        ...
        df_BL.to_csv(DATA_LEAGUE_RAW / 'BundesLiga_Stats_2017_2025.csv')
    ...
    try:
        ...
        df_L1.to_csv(DATA_LEAGUE_RAW / 'Ligue1_Stats_2017_2025.csv')
    ...
    try:
        ...
        df_final.to_csv(DATA_PLAYER_STATS,index=False)


        #Combining datasets
        df_player_stats=pd.read_csv(DATA_PLAYER_STATS)
        ...
        df_stats_new.to_csv(DATA_PLAYER_STATS_MEAN,index=False)
    ...
    try:
        #creating mean stats
        df_mean_stats=pd.read_csv(DATA_PLAYER_STATS_MEAN)

        #transfer dataframe
        df_trans=pd.read_csv(DATA_PLAYER_STATS_MEAN)
        ...
        df_stats.to_csv(DATA_FINAL_STATS,index=False)
        logging.info('Final_Stats_2000_2025 Done')

        df=pd.read_csv(DATA_FINAL_STATS)
        ...
        df.to_csv(DATA_CLEANED_FINAL_STATS,index=False)
    except Exception as ex:
